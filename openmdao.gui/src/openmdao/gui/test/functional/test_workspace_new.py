...
def _test_console_history(browser, project_dict, workspace_page):
...
def _test_palette_update(browser, project_dict, workspace_page):
...
def _test_loading_docs(browser, project_dict, workspace_page):
    #project_dict, workspace_page = startup(browser)
    workspace_page = WorkspacePage.verify(browser, TEST_CONFIG['port'])
...
def _test_file_commit(browser, project_dict, workspace_page):
    #project_dict, workspace_page = startup(browser)
    workspace_page = WorkspacePage.verify(browser, TEST_CONFIG['port'])
...
def _test_macro(browser, project_dict, workspace_page):
    #project_dict, workspace_page = startup(browser)
    workspace_page = WorkspacePage.verify(browser, TEST_CONFIG['port'])
...
def _test_properties(browser, project_dict, workspace_page):
...
def _test_implicit_component(browser, project_dict, workspace_page):
    #project_dict, workspace_page = startup(browser)
    workspace_page = WorkspacePage.verify(browser, TEST_CONFIG['port'])
...
def _test_component_tree(browser, project_dict, workspace_page):
    #project_dict, workspace_page = startup(browser)
    workspace_page = WorkspacePage.verify(browser, TEST_CONFIG['port'])
...
def _test_editable_inputs(browser, project_dict, workspace_page):
    raise SkipTest
...
def _test_console_errors(browser, project_dict, workspace_page):
    #project_dict, workspace_page = startup(browser)
    workspace_page = WorkspacePage.verify(browser, TEST_CONFIG['port'])
...
def _test_driver_config(browser, project_dict, workspace_page):
    #project_dict, workspace_page = startup(browser)
    workspace_page = WorkspacePage.verify(browser, TEST_CONFIG['port'])
...
def _test_remove(browser, project_dict, workspace_page):
    #project_dict, workspace_page = startup(browser)
    workspace_page = WorkspacePage.verify(browser, TEST_CONFIG['port'])
...
def _test_noslots(browser, project_dict, workspace_page):
    #project_dict, workspace_page = startup(browser)
    workspace_page = WorkspacePage.verify(browser, TEST_CONFIG['port'])
...
def _test_logviewer(browser, project_dict, workspace_page):
...
def _test_libsearch(browser, project_dict, workspace_page):
...
def _test_casefilters(browser, project_dict, workspace_page):
...
def _test_sorting(browser, project_dict, workspace_page):
